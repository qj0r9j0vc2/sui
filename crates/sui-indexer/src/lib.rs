...
use sui_json_rpc::{JsonRpcServerBuilder, ServerHandle, dag_api::DagReadApi};
...
pub async fn build_json_rpc_server(
    ...
    builder.register_module(DagReadApi::new(None, JsonRpcMetrics::new(prometheus_registry).into()))?;
